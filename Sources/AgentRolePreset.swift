...
struct AgentRolePreset: Identifiable, Codable, Equatable {
    ...
    static func builtInModels(for cli: String) -> [String] {
        ...
        case "gemini":
            return ["gemini-3.1-pro-preview", "gemini-3-flash-preview", "gemini-2.5-pro", "gemini-2.5-flash", "gemini-2.5-flash-lite"]
        default:
            return ["sonnet", "opus", "haiku"]
        }
    }
...
struct SmartTeamPreset: Identifiable {
    ...
    static let builtIn: [SmartTeamPreset] = [
        ...
        SmartTeamPreset(
            ...
            name: "Idea Discovery",
            icon: "lightbulb",
            description: "Turn a vague idea into a validated plan with 6 specialists",
            leaderMode: "claude",
            agents: [
                ...
                ProviderPreference(role: "planner", primaryCli: "claude", primaryModel: "opus",
                                   fallbackCli: "claude", fallbackModel: "opus", reason: "Task decomposition"),
                ProviderPreference(role: "security", primaryCli: "claude", primaryModel: "opus",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Early risk assessment"),
                ProviderPreference(role: "writer", primaryCli: "claude", primaryModel: "haiku",
                                   fallbackCli: "claude", fallbackModel: "haiku", reason: "PRD & spec documentation"),
            ]
        ),
        SmartTeamPreset(
            id: "researcher",
            ...
            description: "6 domain experts research in parallel for comprehensive analysis",
            leaderMode: "claude",
            agents: [
                ProviderPreference(role: "researcher", primaryCli: "claude", primaryModel: "opus",
                                   fallbackCli: "claude", fallbackModel: "opus", reason: "Core tech research"),
                ProviderPreference(role: "explorer", primaryCli: "gemini", primaryModel: nil,
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "1M context codebase scan"),
                ProviderPreference(role: "architect", primaryCli: "claude", primaryModel: "opus",
                                   fallbackCli: "claude", fallbackModel: "opus", reason: "Architecture evaluation"),
                ProviderPreference(role: "data", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Data model research"),
                ProviderPreference(role: "security", primaryCli: "claude", primaryModel: "opus",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Threat modeling"),
                ProviderPreference(role: "ai", primaryCli: "claude", primaryModel: "opus",
                                   fallbackCli: "claude", fallbackModel: "opus", reason: "AI/ML feasibility & cost"),
            ]
        ),
        SmartTeamPreset(
            id: "mvp",
            name: "Startup MVP",
            icon: "rocket",
            description: "Ship a minimum viable product fast with a full team",
            leaderMode: "claude",
            agents: [
                ProviderPreference(role: "planner", primaryCli: "claude", primaryModel: "opus",
                                   fallbackCli: "claude", fallbackModel: "opus", reason: "Scope & MVP boundary"),
                ProviderPreference(role: "frontend", primaryCli: "gemini", primaryModel: nil,
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "WebDev Arena #1"),
                ProviderPreference(role: "backend", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "API & business logic"),
                ProviderPreference(role: "executor", primaryCli: "codex", primaryModel: nil,
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Fast boilerplate"),
                ProviderPreference(role: "tester", primaryCli: "codex", primaryModel: nil,
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Critical path tests"),
                ProviderPreference(role: "writer", primaryCli: "claude", primaryModel: "haiku",
                                   fallbackCli: "claude", fallbackModel: "haiku", reason: "README & setup guide"),
            ]
        ),
        SmartTeamPreset(
            id: "security-audit",
            ...
            description: "Comprehensive security review across code, infra, and network",
            leaderMode: "claude",
            agents: [
                ProviderPreference(role: "security", primaryCli: "claude", primaryModel: "opus",
                ...
                ProviderPreference(role: "tester", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Security test cases"),
            ]
        ),
        SmartTeamPreset(
            id: "perf-lab",
            ...
            description: "Find bottlenecks, optimize, and verify with benchmarks",
            leaderMode: "claude",
            agents: [
                ProviderPreference(role: "perf", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Profiling & bottlenecks"),
                ProviderPreference(role: "explorer", primaryCli: "gemini", primaryModel: nil,
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Hot path tracing"),
                ProviderPreference(role: "debugger", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Memory leak analysis"),
                ProviderPreference(role: "data", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Query optimization"),
                ProviderPreference(role: "executor", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Optimization impl"),
                ProviderPreference(role: "tester", primaryCli: "codex", primaryModel: nil,
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Benchmarks & regression"),
            ]
        ),
        SmartTeamPreset(
            id: "api-factory",
            ...
            description: "Design, build, secure, and document APIs end-to-end",
            leaderMode: "claude",
            agents: [
                ...
                ProviderPreference(role: "tester", primaryCli: "codex", primaryModel: nil,
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Contract testing"),
                ProviderPreference(role: "security", primaryCli: "claude", primaryModel: "opus",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Auth & injection defense"),
                ProviderPreference(role: "writer", primaryCli: "claude", primaryModel: "haiku",
                                   fallbackCli: "claude", fallbackModel: "haiku", reason: "API docs & examples"),
            ]
        ),
        SmartTeamPreset(
            id: "migration",
            ...
            description: "Large-scale framework, language, or architecture migration",
            leaderMode: "claude",
            agents: [
                ProviderPreference(role: "explorer", primaryCli: "gemini", primaryModel: nil,
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "1M ctx full scan"),
                ProviderPreference(role: "architect", primaryCli: "claude", primaryModel: "opus",
                                   fallbackCli: "claude", fallbackModel: "opus", reason: "Migration strategy"),
                ProviderPreference(role: "refactorer", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Incremental conversion"),
                ProviderPreference(role: "executor", primaryCli: "codex", primaryModel: nil,
        ...
        SmartTeamPreset(
            ...
            name: "AI Product",
            icon: "cpu",
            description: "Build LLM/RAG-powered features with AI specialists",
            leaderMode: "claude",
            agents: [
                ProviderPreference(role: "ai", primaryCli: "claude", primaryModel: "opus",
                                   fallbackCli: "claude", fallbackModel: "opus", reason: "Prompt & RAG pipeline"),
                ProviderPreference(role: "architect", primaryCli: "claude", primaryModel: "opus",
                                   fallbackCli: "claude", fallbackModel: "opus", reason: "System & cost design"),
                ProviderPreference(role: "backend", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "API orchestration"),
                ProviderPreference(role: "data", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Vector DB & embeddings"),
                ProviderPreference(role: "executor", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Integration impl"),
                ProviderPreference(role: "tester", primaryCli: "claude", primaryModel: "sonnet",
                                   fallbackCli: "claude", fallbackModel: "sonnet", reason: "Eval & hallucination tests"),
            ]
        ),
    ]
}
