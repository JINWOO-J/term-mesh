...
AGENT_INIT_PROMPT = (
    ...
    '\n'
    'Fast RPC (use for frequent/speed-critical operations):\n'
    '- Report: `./scripts/tm-rpc.sh report \'<summary>\'`\n'
    '- Heartbeat: `./scripts/tm-rpc.sh heartbeat \'<status>\'`\n'
    '- Message: `./scripts/tm-rpc.sh msg \'<text>\' --to <agent_name>`\n'
    '- Task done: `./scripts/tm-rpc.sh task-done <task_id> \'<result>\'`\n'
    '- Check status: `./scripts/tm-rpc.sh status`\n'
    '- Check inbox: `./scripts/tm-rpc.sh inbox`\n'
    'tm-rpc.sh is ~15x faster than team.py (~10ms vs ~250ms). '
    'Use team.py for complex operations (create, delegate, read, collect).\n'
    '\n'
    'Environment:\n'
    ...
    './scripts/tm-rpc.sh report \'<summary of your result>\'\n'
    'Or use `./scripts/team.py reply \'<summary>\'` which also sends a message to the leader. '
