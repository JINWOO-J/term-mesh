...
REPORT_SUFFIX = (
    '\n\n[IMPORTANT] Use `tm-rpc` (Rust, ~2ms) for ALL team operations. '
    'Fallback: `./scripts/tm-rpc.sh` (~10ms). '
    'NEVER use `./scripts/team.py` from agents — it is 100x slower (~250ms).\n'
    '\n'
    'Task lifecycle:\n'
    '1. Begin assigned work: `tm-rpc task-start <task_id>`\n'
    '2. Progress heartbeat: `tm-rpc heartbeat \'<short progress summary>\'`\n'
    '3. If blocked: `tm-rpc task-block <task_id> \'<reason>\'`\n'
    '4. If ready for review: `./scripts/team.py task review <task_id> \'<summary>\'`'
    ' (exception: tm-rpc does not yet support task-review)\n'
    '5. When done: `tm-rpc task-done <task_id> \'<result>\'`\n'
    'If the leader did not give you a task id, report that and ask for one.\n'
    '\n'
    '[IMPORTANT] When you finish this task, you MUST use your bash/execute tool to run:\n'
    '```\n'
    'tm-rpc report \'<one-paragraph summary of your result>\'\n'
    '```\n'
...
AGENT_INIT_PROMPT = (
    ...
    'Use `tm-rpc` (Rust, ~2ms) for ALL team operations. '
    'Fallback: `./scripts/tm-rpc.sh` (bash, ~10ms). '
    'NEVER use `./scripts/team.py` — it is 100x slower (~250ms).\n'
    '\n'
    'Task lifecycle:\n'
    '1. Begin task: `tm-rpc task-start <task_id>`\n'
    '2. Progress heartbeat: `tm-rpc heartbeat \'<short summary>\'`\n'
    '3. If blocked: `tm-rpc task-block <task_id> \'<reason>\'`\n'
    '4. If ready for review: `./scripts/team.py task review <task_id> \'<summary>\'`'
    ' (exception: tm-rpc does not yet support task-review)\n'
    '5. When done: `tm-rpc task-done <task_id> \'<result>\'`\n'
    '\n'
    'Communication:\n'
    '- Send message to leader: `tm-rpc msg \'<text>\'`\n'
    '- Send message to another agent: `tm-rpc msg \'<text>\' --to <agent_name>`\n'
    '- Check your inbox: `tm-rpc inbox`\n'
    '- Check team status: `tm-rpc status`\n'
    '- Check tasks: `tm-rpc tasks`\n'
    '- Report result: `tm-rpc report \'<summary>\'`\n'
    '\n'
    'Environment:\n'
    ...
    'tm-rpc report \'<summary of your result>\'\n'
